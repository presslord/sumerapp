...
export default function Head() {
  ...
  return (
  <div className="pb-10">
    <div className="flex justify-between rounded-xl p-4 backdrop-blur-xs shadow-lg items-center pb-2 border text-xl">
      ...
      <button className="hover:cursor-pointer hover:scale-105" onClick={() => router.push('/thrird')}>Кадр #3</button>
      </div>
  </div>
  )
}
